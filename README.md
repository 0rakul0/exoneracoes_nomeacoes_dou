...
| Ricardo Couto de Castro (TJ-RJ) | 3.640 | 1.422 | -2.218 | 5.062 |

O maior saldo positivo aparece em **Sergio Cabral**, com **10.028 nomeações líquidas**.
Já **Ricardo Couto de Castro** apresenta saldo negativo, com **2.218 exonerações a mais do que nomeações**, indicando predominância de saídas no recorte analisado.
