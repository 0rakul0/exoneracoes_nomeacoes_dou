...
O workflow `.github/workflows/coletar-doerj.yml` roda `python main.py` manualmente (`workflow_dispatch`) ou todos os dias as 08:30 UTC. Ele usa runner `self-hosted`, porque os runners hospedados pelo GitHub nao expoem a sua GPU local.
